...
/* Public Globals */
extern const struct Element slider_right_element;     // structure containing elements for
extern const struct Element slider_left_element;     //
extern const struct Element slider_middle_element;     //
extern const struct Element left;     //
extern const struct Element on_off_element;     //
extern const struct Element measurement_element;     //

extern const struct Sensor voltage_slider;

extern const struct Sensor on_off_button;    // structure of info for a given

extern const struct Sensor measurement_button;    // structure of info for a given
